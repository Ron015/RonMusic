...
import com.ron.music.BuildConfig
...
import com.ron.music.ui.component.ReleaseNotesCard
    ...
    PreferenceEntry(
        ...
        if (latestVersionName != BuildConfig.VERSION_NAME) {
            PreferenceEntry(
                ...
                onClick = {
                    uriHandler.openUri("https://github.com/ron015/ronmusic/releases/latest/download/RonMusic.apk")
                }
            )
            ReleaseNotesCard()
        }

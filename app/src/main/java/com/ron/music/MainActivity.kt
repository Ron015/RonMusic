...
import com.ron.music.constants.AppBarHeight
import com.ron.music.constants.DarkModeKey
import com.ron.music.constants.DefaultOpenTabKey
import com.ron.music.constants.DisableScreenshotKey
import com.ron.music.constants.DynamicThemeKey
import com.ron.music.constants.MiniPlayerHeight
import com.ron.music.constants.NavigationBarAnimationSpec
import com.ron.music.constants.NavigationBarHeight
import com.ron.music.constants.PauseSearchHistoryKey
import com.ron.music.constants.PureBlackKey
import com.ron.music.constants.SearchSource
import com.ron.music.constants.SearchSourceKey
import com.ron.music.constants.SlimNavBarKey
import com.ron.music.constants.StopMusicOnTaskClearKey
import com.ron.music.db.MusicDatabase
import com.ron.music.db.entities.SearchHistory
import com.ron.music.extensions.toEnum
import com.ron.music.models.toMediaMetadata
import com.ron.music.playback.DownloadUtil
import com.ron.music.playback.MusicService
import com.ron.music.playback.MusicService.MusicBinder
import com.ron.music.playback.PlayerConnection
import com.ron.music.playback.queues.YouTubeQueue
import com.ron.music.ui.component.BottomSheetMenu
import com.ron.music.ui.component.IconButton
import com.ron.music.ui.component.LocalMenuState
import com.ron.music.ui.component.TopSearch
import com.ron.music.ui.component.rememberBottomSheetState
import com.ron.music.ui.component.shimmer.ShimmerTheme
import com.ron.music.ui.menu.YouTubeSongMenu
import com.ron.music.ui.player.BottomSheetPlayer
import com.ron.music.ui.screens.Screens
import com.ron.music.ui.screens.navigationBuilder
import com.ron.music.ui.screens.search.LocalSearchScreen
import com.ron.music.ui.screens.search.OnlineSearchScreen
import com.ron.music.ui.screens.settings.DarkMode
import com.ron.music.ui.screens.settings.LocaleManager
import com.ron.music.ui.screens.settings.NavigationTab
import com.ron.music.ui.theme.ColorSaver
import com.ron.music.ui.theme.DefaultThemeColor
import com.ron.music.ui.theme.MetrolistTheme
import com.ron.music.ui.theme.extractThemeColor
import com.ron.music.ui.utils.appBarScrollBehavior
import com.ron.music.ui.utils.backToMain
import com.ron.music.ui.utils.resetHeightOffset
import com.ron.music.utils.SyncUtils
import com.ron.music.utils.Updater
import com.ron.music.utils.dataStore
import com.ron.music.utils.get
import com.ron.music.utils.rememberEnumPreference
import com.ron.music.utils.rememberPreference
...
class MainActivity : ComponentActivity() {
    ...
    companion object {
        const val ACTION_SEARCH = "com.ron.music.action.SEARCH"
        const val ACTION_EXPLORE = "com.ron.music.action.EXPLORE"
        const val ACTION_LIBRARY = "com.ron.music.action.LIBRARY"
    }
}
